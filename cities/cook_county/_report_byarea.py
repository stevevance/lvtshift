...
<p class='lede'>Modeled impact of replacing the <b>entire</b> Cook County property tax (every taxing
body combined, ~$19.2B for tax year 2024) with one revenue-neutral land shift across the whole
county. Current tax = each parcel's gross equalized value × its tax code's composite rate (Cook
County Clerk). Two reforms: a <b>2.5:1 split-rate</b> (land taxed 2.5× buildings, the Illinois
classification cap) and a <b>100% building abatement</b> (pure land tax). Tax changes are solved
county-wide; each view is the slice of parcels in the selected assessment township. Positive = pays more.</p></header>
<div class='controls'>
